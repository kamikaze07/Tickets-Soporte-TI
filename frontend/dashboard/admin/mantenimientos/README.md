...
Sistema integral para la gestión de **Mantenimientos Preventivos y
Correctivos**, completamente integrado al módulo de **Inventario TI**.
...
4.  Actualizar mantenimiento:
    ...
    -   realizado_por\
    -   token_validacion\
5.  Insertar movimiento histórico\
6.  Generar PDF dinámico
